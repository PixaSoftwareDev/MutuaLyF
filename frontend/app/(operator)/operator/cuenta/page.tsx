          ...
          <CardContent className="space-y-4">
            <Field label="Nombre completo">
              ...
              <p className="text-[11px] text-muted-foreground mt-1">
                Es el nombre que ven los afiliados cuando entrás a una conversación.
              </p>
            </Field>
            ...
            <Field label="Email">
              ...
              />
              <p className="text-[11px] text-muted-foreground mt-1">
                Para cambiar el email, pedile al administrador.
              </p>
            </Field>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Field label="Sectores asignados">
                <div className="h-9 rounded-md border border-input bg-muted/60 px-3 text-sm flex items-center text-muted-foreground truncate">
                  {me.sectors.length === 0
                    ? "Ninguno"
                    : me.sectors.map(s => s.nombre).join(", ")}
                </div>
              </Field>
            </div>
