...
_JUDGE_SYSTEM = (
    ...
    "responde.\n"
    "3c. RESPUESTA POR DESCARTE: si un fragmento documenta el conjunto "
    "COMPLETO de opciones (los días u horarios de atención, la lista de "
    "profesionales o especialidades, los medios de pago habilitados) y la "
    "pregunta es por un elemento que NO está en ese conjunto, el fragmento SÍ "
    "responde — la respuesta es que ese elemento no está disponible (ej: "
    "preguntan si atienden los sábados y el fragmento dice que la atención es "
    "de lunes a viernes → responde: los sábados no hay atención). Esto solo "
    "aplica cuando el fragmento enuncia el conjunto completo, no cuando da "
    "ejemplos sueltos.\n"
